...
class ServiceResponseDTO(BaseModel):
    ...
    dictionary_data: Optional[ExcelRowDataResponseDTO] = None  # <--- NUEVO: Datos del maestro
    ...
    def from_domain(cls, entity: ServiceEntity):
        ...
        # --- NUEVO: Mapeo de los datos del diccionario si existen ---
        dict_data_dto = None
        ...
        return cls(
            ...
            dictionary_data=dict_data_dto, # <--- Se lo pasamos a la respuesta
